...
begin         //emptystr significa diferente de vazia <> emptystr, e uma string vazia
...
begin
   // pede para incluir o registro, append insiri um novo registro
   cdsOriginal.Append;
   //passa in ClientDataSet1formações para o registro
